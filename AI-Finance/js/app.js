...
/* Deep-linking: ?page=<id> (e.g. from the portfolio's "Launch Full
   Prototype" button) opens straight to that tab after sign-in instead of
   the default Dashboard. Unknown/absent page ids are ignored. */
function applyDeepLink() {
  const page = new URLSearchParams(window.location.search).get("page");
  if (page && PAGES[page]) openTab(page);
}
